...
<select name="credit_card_company">
	<option value="VISA"
		<c:if test="${user.credit_card_company == 0}"> selected</c:if>>VISA</option>
	<option value="MasterCard"
		<c:if test="${user.credit_card_company == 1}"> selected</c:if>>MasterCard</option>
	<option value="JCB"
		<c:if test="${user.credit_card_company == 2}"> selected</c:if>>JCB</option>
	<option value="American Express"
		<c:if test="${user.credit_card_company == 3}"> selected</c:if>>American
		Express</option>
</select>
<br />
<br />
